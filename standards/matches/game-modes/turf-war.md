...
### Archetypes
#### Archetype usage
Archetypes are enabled for this game mode. 

#### Default archetype
The archetype that the contestant had in the lobby will be their default archetype. If the contestant did not choose an archetype in the lobby or no archetype can be found, the player will not have a default archetype.
...
#### Bot personalities
Bots will be randomly assigned a personality that will define how they interact with the game. Personalities include:
...
### Destroyed parts
Some parts in stages have specific durability levels set by the stage creators. If a part's current durability level reaches 0, the part will be marked as "destroyed". Parts without a durability level cannot be destroyed.
...
From this screen, the player can ask for a rematch with the same participants or return to the lobby. Players who approve rematch requests will be queued together in a new match, while the players who refuse the request will stay behind. Bots instantly accept rematch requests.
